...
TEST_F(DataTypeDecimalSerDeTest, RowStoreDecimalJsonbWidth) {
    ...
    check_decimal_row_store_jsonb_width(*serde_decimal32_4, Decimal32(128), 0, JsonbType::T_Int16);
    ...
    check_decimal_row_store_jsonb_width(*serde_decimal64_1, Decimal64(static_cast<Int64>(1) << 40),
                                        0, JsonbType::T_Int64);
    check_decimal_row_store_jsonb_width(*serde_decimal128v2, DecimalV2Value(static_cast<Int128>(1)),
                                        9, JsonbType::T_Int8);
    ...
    check_decimal_row_store_jsonb_width(*serde_decimal128v2,
                                        ...
                                        JsonbType::T_Int128);
    check_decimal_row_store_jsonb_width(*serde_decimal128v3_1, Decimal128V3(static_cast<Int128>(1)),
                                        0, JsonbType::T_Int8);
    ...
    auto check_fixed_width_value = [](auto& serde, auto expected, int scale,
                                      JsonbType expected_type, auto write_value) {
        JsonbWriterT<JsonbOutStream> jsonb_writer;
        jsonb_writer.writeStartObject();
    ...
    check_fixed_width_value(serde_decimal32_4, Decimal32(1), 0, JsonbType::T_Int32,
                            [](JsonbWriter& writer) { writer.writeInt32(1); });
    check_fixed_width_value(serde_decimal64_1, Decimal64(1), 0, JsonbType::T_Int64,
                            [](JsonbWriter& writer) { writer.writeInt64(1); });
    check_fixed_width_value(serde_decimal128v2, DecimalV2Value(static_cast<Int128>(1)), 9,
                            JsonbType::T_Int128,
                            [](JsonbWriter& writer) { writer.writeInt128(1); });
    check_fixed_width_value(serde_decimal128v3_1, Decimal128V3(static_cast<Int128>(1)), 0,
                            JsonbType::T_Int128,
                            [](JsonbWriter& writer) { writer.writeInt128(1); });
}
} // namespace doris
