...
void check_number_row_store_jsonb_fixed_width_read_compat(
...
TEST_F(DataTypeNumberSerDeTest, RowStoreIntegerJsonbWidth) {
    ...
    check_number_row_store_jsonb_width<TYPE_LARGEINT>(static_cast<Int128>(1), JsonbType::T_Int8);
    ...
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_BOOLEAN>(
            1, JsonbType::T_Int8, [](JsonbWriter& writer) { writer.writeInt8(1); });
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_TINYINT>(
            -1, JsonbType::T_Int8, [](JsonbWriter& writer) { writer.writeInt8(-1); });
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_SMALLINT>(
            1, JsonbType::T_Int16, [](JsonbWriter& writer) { writer.writeInt16(1); });
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_INT>(
            1, JsonbType::T_Int32, [](JsonbWriter& writer) { writer.writeInt32(1); });
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_BIGINT>(
            1, JsonbType::T_Int64, [](JsonbWriter& writer) { writer.writeInt64(1); });
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_LARGEINT>(
...
TEST_F(DataTypeNumberSerDeTest, RowStoreDateTimeJsonbWidth) {
    ...
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_DATE>(
    ...
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_DATETIME>(
    ...
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_DATEV2>(
    ...
    check_number_row_store_jsonb_width<TYPE_DATETIMEV2>(
            datetimev2, expected_jsonb_integer_type(*reinterpret_cast<const UInt64*>(&datetimev2)));
    const auto datetimev2_raw_value = *reinterpret_cast<const UInt64*>(&datetimev2);
    check_number_row_store_jsonb_fixed_width_read_compat<TYPE_DATETIMEV2>(
