...
struct TMasterOpRequest {
    ...
    32: optional bool AIFunctionsFoldByBe
...
struct TLegacyUpsertTxnStateRequest {
    1: optional string user
    2: optional string passwd
    3: optional string token
    4: optional string catalog
...
struct TLegacyUpsertTxnStateResult {
    1: optional Status.TStatus status
    2: optional Types.TNetworkAddress master_address
}
...
service FrontendService {
    ...
    TLegacyUpsertTxnStateResult legacyUpsertTxnState(1: TLegacyUpsertTxnStateRequest request)
}
