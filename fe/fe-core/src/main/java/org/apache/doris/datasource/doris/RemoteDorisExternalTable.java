...
public class RemoteDorisExternalTable extends ExternalTable {
            ...
            synchronized (this) {
                if (!isSyncOlapTable) {
                    try {
                        ...
                        tempPartitions = Lists.newArrayList(olapTable.getTempPartition().getPartitions());
    ...
    public Optional<SchemaCacheValue> initSchema() {
        OlapTable olapTable = getDorisOlapTable();
        return Optional.of(new SchemaCacheValue(olapTable.getBaseSchema()));
    }
    ...
    public long fetchRowCount() {
        // partial copy from RowCountAction
        OlapTable olapTable = getDorisOlapTable();
        long rowCount = 0;
