...
public class RemoteOlapTable extends OlapTable {
    ...
    public List<Backend> getAllBackends() {
        return Env.getCurrentEnv().getExtMetaCacheMgr().getDorisExternalMetaCacheMgr()
                .getBackends(catalog.getId()).values().asList();
    }
    ...
    public Backend getBackend(long backendId) {
        return Env.getCurrentEnv().getExtMetaCacheMgr().getDorisExternalMetaCacheMgr()
                .getBackends(catalog.getId()).get(backendId);
    }
}
