...
public class RemoteDorisRestClient {
    ...
    private OkHttpClient initHttpClient(boolean httpSslEnable, int maxIdleConnections, long keepAliveDurationSec,
            long connectTimeoutSec, long readTimeoutSec, long writeTimeoutSec, long callTimeoutSec) {
