 ...
 */
public class ShowCreateStreamCommand extends Command implements NoForward {
    ...
    private void validate(ConnectContext ctx) throws AnalysisException {
        ...
        TableIf tableIf = Env.getCurrentEnv().getCatalogMgr()
                ...
                .getTableOrAnalysisException(tblNameInfo.getTbl());
        ...
        if (!Env.getCurrentEnv().getAccessManager().checkTblPriv(ConnectContext.get(),
                tblNameInfo.getCtl(), tblNameInfo.getDb(), tblNameInfo.getTbl(), PrivPredicate.SHOW)) {
    ...
    public void run(ConnectContext ctx, StmtExecutor executor) throws Exception {
        ...
        DatabaseIf<?> db = ctx.getEnv().getCatalogMgr()
                .getCatalogOrAnalysisException(tblNameInfo.getCtl())
        ...
        try {
            ...
            Env.getDdlStmt(null, null, stream, createStreamStmt, null, null, false,
                    true, false, -1L, false, false);
